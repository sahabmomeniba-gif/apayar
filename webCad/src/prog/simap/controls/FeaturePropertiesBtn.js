...
class FeatureControlBtn extends Control {
  constructor(opt_options) {
    const options = opt_options || {};

    // ImportButton.innerHTML = 'Import DXF';
    const element = document.createElement('div');
    element.className = "FeatureControlBtn"
    ...
    super({
      ...
      `
      <input type="button" class="set_panel" value="ctrl+1/features Properties">
...
export default FeatureControlBtn