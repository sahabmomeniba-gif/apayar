...
class SnapControlBtn extends Control {
  constructor(opt_options) {
    const options = opt_options || {};

    // ImportButton.innerHTML = 'Import DXF';
    const element = document.createElement('div');
    element.className = "SnapControlBtn"
    ...
    super({
      ...
      `
      <input type="button" class="set_panel" value="ctrl+3/snaps Properties">
